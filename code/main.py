...
def main(args):
    ...
    dataset = SEADataset(args.data_path)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print(f"Relative loss of the network on the {len(dataset_val)} test images: {test_stats['loss']:.3f}")
